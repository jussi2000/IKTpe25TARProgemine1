...
namespace Mapping
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //mappimine on see, kus mõlema klassi muutujad viiakse omavahel kokku
            //protsess, kus muudetkse andmed ühest formaadist, struktuurist või
            //süsteemist teiseks

            //kasutatakse väärtustes ja muutmiste abil, et ühendada andmebaasis
            //olevate tabelistega
            dto.Id = emp.Id;
            dto.Name = emp.Name;
            dto.Title = emp.Title;
            ...
            var loggerFactory = LoggerFactory.Create(ILoggingBuilder
                => { });
